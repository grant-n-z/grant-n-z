...
func TestGetServerConfig(t *testing.T) {
	serverConfig := ServerConfig{
		...
		ValidatePublicKeyBase64:  "$SERVER_PUBLIC_KEY",
	...
	if !strings.EqualFold(ymlConfig.GetServerConfig().ValidatePublicKeyBase64, "") {
		t.Errorf("Incorrect GetServerConfig test. public_key_base64 = %s", ymlConfig.GetServerConfig().SignedInPrivateKeyBase64)
		t.FailNow()
	}

	if !strings.EqualFold(ymlConfig.GetServerConfig().TokenExpireHourStr, "100") {
		t.Errorf("Incorrect GetServerConfig test. token-expire-hour = %s", ymlConfig.GetServerConfig().ValidatePublicKeyBase64)
		t.FailNow()
	}
